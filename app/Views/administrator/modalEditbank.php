    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary-gradient">
                <h5 class="modal-title text-white" id="staticBackdropLabel">Edit Bank</h5>
            </div>
            <?= form_open_multipart('', ['class' => 'frmupdatebank']) ?>
            <div class="modal-body">
                <?= csrf_field() ?>
                <div class="form-row">
                    <div class="col-md-2">
                        <input type="hidden" name="id_bank" value="<?= $id_bank ?>">
                        <input type="hidden" name="imgLama" value="<?= $logo_bank ?>">
                        <div class="form-group">
                            <label for="kode_bank" class="col-sm-3 col-form-label">Kode Bank</label>
                            <div class="col-sm-12">
                                <input type="text" name="kode_bank" value="<?= $kode_bank ?>" id="kode_bank" class="form-control" placeholder="Kode">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control date" value="<?= $nama_bank ?>" name="nama_bank" placeholder="Nama Bank" id="nama_bank">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="cabang" value="<?= $cabang ?>" placeholder="Cabang" id="cabang">
                ...
                <div class="form-row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="no_rekening" value="<?= $no_rekening ?>" placeholder="Nomor Rekening" id="no_rekening">
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="nama_rekening" id="nama_rekening" value="<?= $nama_rekening ?>" placeholder="Nama Rekening">
                ...
                <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label pic" for="logo_bank"><?= $logo_bank ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <img src="/img/bank/<?= $logo_bank ?>" style="max-width: 300px; max-height:300px;" class="rounded img-thumbnail img-preview">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.btnSave').on('click', function(e) {
            e.preventDefault();
            let form = $('.frmupdatebank')[0];
            let data = new FormData(form);
            $.ajax({
                type: "post",
                url: '/auth/bank/updatebank',
                data: data,
