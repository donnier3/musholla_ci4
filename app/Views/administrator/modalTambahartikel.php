...
<!-- Modal -->
<div class="modal fade" id="modal-tambahartikel" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary-gradient">
                <h5 class="modal-title text-white" id="staticBackdropLabel">Tambah Artikel</h5>
            </div>
            <?= form_open_multipart('', ['class' => 'frmtambahartikel']) ?>
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="col-4">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="penulis" placeholder="Nama Penulis" id="penulis">
                    ...
                    <div class="col-4">
                        <div class="col-12">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="judul_artikel" placeholder="Judul Artikel" id="judul_artikel">
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-sm-12">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="img_artikel" name="img_artikel" onchange="previewPIc()">
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-sm-12 form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" id="status_artikel">
...
<script>
    ...
    function previewPic() {
        const img_artikelLabel = document.querySelector('.custom-file-label');

        img_artikelLabel.textContent = img_artikel.files[0].name;
    }
    ...
    $(document).ready(function() {
        ...
        $('.frmtambahartikel').submit(function(e) {
            e.preventDefault();
            let form = $('.frmtambahartikel')[0];
            let data = new FormData(form);
            $.ajax({
                type: "post",
                url: '/auth/artikel/tambahartikel',
                data: data,
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        $('#modal-tambahartikel').modal('hide');
                        data_artikel();
                    }
                },
