    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary-gradient">
                <h5 class="modal-title text-white" id="staticBackdropLabel">Tambah Pengeluaran</h5>
            </div>
            <?= form_open_multipart('', ['class' => 'frmtambahkeluar']) ?>
            <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <!-- <input type="text" class="form-control" name="id_subkategorikeluar" placeholder="Email" id="id_subkategorikeluar"> -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-12">
                                ...
                                <input type="text" class="form-control" name="jumlah_keluar" placeholder="Jumlah pengeluaran" id="jumlah_keluar">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-12" id="reservationdate" data-target-input="nearest">
                                <input type="text" class="form-control date" name="tgl_keluar" data-date-format="yyyy-mm-dd" data-date-end-date="0d" placeholder="Tanggal pengeluaran" id="tgl_keluar" data-target="#reservationdate">
                ...
                <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label pic" for="bukti_keluar">Choose File..</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <img src="" style="max-width: 300px; max-height:300px;" class="rounded img-thumbnail bukti-preview">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // $('.frmtambahkeluar').submit(function(e) {
        $('.btnSave').on('click', function(e) {
            e.preventDefault();
            let form = $('.frmtambahkeluar')[0];
            let data = new FormData(form);
            $.ajax({
                type: "post",
                url: '/auth/pengeluaran/tambahkeluar',
                data: data,
                ...
                success: function(response) {
                    if (response.error) {
                        if (response.error.id_kategorikeluar) {
                            ...
                            $('.errJenis').html(response.error.id_kategorikeluar);
                        } else {
                            $('#id_kategorikeluar').removeClass('is-invalid');
                            $('#id_kategorikeluar').addClass('is-valid');
                            $('.errJenis').html(response.error.id_kategorikeluar);
                        }
                        if (response.error.id_subkategorikeluar) {
                            $('#id_subkategorikeluar').addClass('is-invalid');
                            $('.errNama').html(response.error.id_subkategorikeluar);
                        } else {
                            $('#id_subkategorikeluar').removeClass('is-invalid');
                            $('#id_subkategorikeluar').addClass('is-valid');
                            $('.errNama').html(response.error.id_subkategorikeluar);
                        }
