...
<div class="modal fade" id="modal-edit" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('/auth/kategoriartikel/updateKategori', ['class' => 'frmupdatekategori']) ?>
            <div class="modal-body">
                <?= csrf_field() ?>
                <div class="form-group row">
                    <label for="nama_kategoriartikel" class="col-sm-3 col-form-label">Nama Kategori</label>
                    <div class="col-sm-9">
                        <input type="hidden" name="id_kategoriartikel" value="<?= $id_kategoriartikel ?>">
                        <input type="hidden" name="slug_kategoriartikel" value="<?= $slug_kategoriartikel ?>">
                        <input type="text" class="form-control" value="<?= $nama_kategoriartikel ?>" name="nama_kategoriartikel" placeholder="Nama Kategori" id="nama_kategoriartikel" autofocus>
